...
void C10_general_EV_circuit_pr(
  /* general_EV/ */
  kcg_bool general_EV,
  /* circuit_pressurized/ */
  ...
  outC_C10_general_EV_circuit_pr *outC)
{
  ...
  switch (outC->SM1_state_sel) {
    case _83_SSM_st_Failure_SM1 :
      _12_SM1_state_act_partial = _83_SSM_st_Failure_SM1;
      break;
    case _82_SSM_st_Detection_SM1 :
      tr_2_guard_Detection_SM1 = outC->o_times_2_size;
      tr_1_guard_Detection_SM1 = circuit_pressurized == kcg_true;
      if (tr_1_guard_Detection_SM1) {
        _9_SM1_state_act_partial = _84_SSM_st_Normal_SM1;
      }
      else if (tr_2_guard_Detection_SM1) {
        _9_SM1_state_act_partial = _83_SSM_st_Failure_SM1;
      }
      else {
        _9_SM1_state_act_partial = _82_SSM_st_Detection_SM1;
      }
      break;
    default :
      /* this branch is empty */
  ...
  switch (outC->SM1_state_sel) {
    case _83_SSM_st_Failure_SM1 :
      ...
      _14_SM1_fired_strong_partial = _85_SSM_TR_no_trans_SM1;
      outC->SM1_fired_strong = _14_SM1_fired_strong_partial;
      break;
    case _82_SSM_st_Detection_SM1 :
      outC->SM1_state_act = _9_SM1_state_act_partial;
      if (tr_1_guard_Detection_SM1) {
        _11_SM1_fired_strong_partial = _86_SSM_TR_Detection_Normal_1_Detection_SM1;
      }
      else if (tr_2_guard_Detection_SM1) {
        _11_SM1_fired_strong_partial = _87_SSM_TR_Detection_Failure_2_Detection_SM1;
      }
      else {
        _11_SM1_fired_strong_partial = _85_SSM_TR_no_trans_SM1;
      }
      outC->SM1_fired_strong = _11_SM1_fired_strong_partial;
      break;
    case _84_SSM_st_Normal_SM1 :
      tr_1_guard_Normal_SM1 = general_EV & outC->general_EV_changed;
      if (tr_1_guard_Normal_SM1) {
        SM1_state_act_partial = _82_SSM_st_Detection_SM1;
      }
      else {
        SM1_state_act_partial = _84_SSM_st_Normal_SM1;
      }
      outC->SM1_state_act = SM1_state_act_partial;
      if (tr_1_guard_Normal_SM1) {
        SM1_fired_strong_partial = _88_SSM_TR_Normal_Detection_1_Normal_SM1;
      }
      else {
        SM1_fired_strong_partial = _85_SSM_TR_no_trans_SM1;
      }
  ...
  switch (outC->SM1_state_act) {
    case _83_SSM_st_Failure_SM1 :
      ...
      _6_SM1_state_nxt_partial = _83_SSM_st_Failure_SM1;
    ...
    case _82_SSM_st_Detection_SM1 :
      ...
      _2_SM1_state_nxt_partial = _82_SSM_st_Detection_SM1;
    ...
    case _84_SSM_st_Normal_SM1 :
      ...
      SM1_state_nxt_partial = _84_SSM_st_Normal_SM1;
...
void C10_general_EV_circuit_pr_init(outC_C10_general_EV_circuit_pr *outC)
{
  outC->_L14 = kcg_true;
  outC->_L9 = kcg_true;
  outC->general_EV_changed = kcg_true;
  outC->SM1_fired = _85_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _85_SSM_TR_no_trans_SM1;
  outC->SM1_state_act = _84_SSM_st_Normal_SM1;
  outC->SM1_state_sel = _84_SSM_st_Normal_SM1;
  outC->_L1_Failure_SM1 = kcg_true;
  ...
  outC->SM1_state_nxt = _84_SSM_st_Normal_SM1;
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void C10_general_EV_circuit_pr_reset(outC_C10_general_EV_circuit_pr *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
