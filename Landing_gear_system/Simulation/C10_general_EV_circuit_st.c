...
#include "C10_general_EV_circuit_st.h"

/* C10_general_EV_circuit_state_high2low/ */
void C10_general_EV_circuit_st(
...
void C10_general_EV_circuit_st_init(outC_C10_general_EV_circuit_st *outC)
{
  outC->_L14 = kcg_true;
  outC->_L9 = kcg_true;
...
void C10_general_EV_circuit_st_reset(outC_C10_general_EV_circuit_st *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
