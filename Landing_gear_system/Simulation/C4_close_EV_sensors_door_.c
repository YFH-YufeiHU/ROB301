...
void C4_close_EV_sensors_door_(
  /* door_opened_front/ */
  ...
  outC_C4_close_EV_sensors_door_ *outC)
{
  ...
  /* SM1: */
  _12_SSM_ST_SM1 _2_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _3_SM1_reset_nxt_partial;
  /* SM1: */
  _13_SSM_TR_SM1 _4_SM1_fired_partial;
  /* anomaly/ */
  kcg_bool _5_anomaly_partial;
  /* SM1: */
  _12_SSM_ST_SM1 _6_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _7_SM1_reset_nxt_partial;
  /* SM1: */
  _13_SSM_TR_SM1 _8_SM1_fired_partial;
  /* SM1: */
  ...
  /* SM1: */
  _12_SSM_ST_SM1 _9_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _10_SM1_reset_act_partial;
  /* SM1: */
  _13_SSM_TR_SM1 _11_SM1_fired_strong_partial;
  /* SM1:Detection:<2> */
  kcg_bool tr_2_guard_Detection_SM1;
  /* SM1:Detection:<1> */
  kcg_bool tr_1_guard_Detection_SM1;
  /* SM1: */
  _12_SSM_ST_SM1 _12_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _13_SM1_reset_act_partial;
  /* SM1: */
  _13_SSM_TR_SM1 _14_SM1_fired_strong_partial;
  /* SM1: */
  ...
  switch (outC->SM1_state_sel) {
    case _41_SSM_st_Failure_SM1 :
      _12_SM1_state_act_partial = _41_SSM_st_Failure_SM1;
      break;
    case _40_SSM_st_Detection_SM1 :
  ...
  outC->any_door_opened_true = outC->_L20;
  switch (outC->SM1_state_sel) {
    case _40_SSM_st_Detection_SM1 :
      tr_1_guard_Detection_SM1 = outC->any_door_opened_true == kcg_false;
      if (tr_1_guard_Detection_SM1) {
        _9_SM1_state_act_partial = _42_SSM_st_Normal_SM1;
      }
      else if (tr_2_guard_Detection_SM1) {
        _9_SM1_state_act_partial = _41_SSM_st_Failure_SM1;
      }
      else {
        _9_SM1_state_act_partial = _40_SSM_st_Detection_SM1;
      }
      break;
    default :
      /* this branch is empty */
  ...
  outC->close_EV_changed = outC->_L9;
  /* SM1: */
  switch (outC->SM1_state_sel) {
    case _41_SSM_st_Failure_SM1 :
      outC->SM1_state_act = _12_SM1_state_act_partial;
      _14_SM1_fired_strong_partial = _43_SSM_TR_no_trans_SM1;
      outC->SM1_fired_strong = _14_SM1_fired_strong_partial;
      break;
    case _40_SSM_st_Detection_SM1 :
      outC->SM1_state_act = _9_SM1_state_act_partial;
      if (tr_1_guard_Detection_SM1) {
        _11_SM1_fired_strong_partial = _44_SSM_TR_Detection_Normal_1_Detection_SM1;
      }
      else if (tr_2_guard_Detection_SM1) {
        _11_SM1_fired_strong_partial = _45_SSM_TR_Detection_Failure_2_Detection_SM1;
      }
      else {
        _11_SM1_fired_strong_partial = _43_SSM_TR_no_trans_SM1;
      }
      outC->SM1_fired_strong = _11_SM1_fired_strong_partial;
      break;
    case _42_SSM_st_Normal_SM1 :
      tr_1_guard_Normal_SM1 = close_EV & outC->close_EV_changed;
      if (tr_1_guard_Normal_SM1) {
        SM1_state_act_partial = _40_SSM_st_Detection_SM1;
      }
      else {
        SM1_state_act_partial = _42_SSM_st_Normal_SM1;
      }
      outC->SM1_state_act = SM1_state_act_partial;
      if (tr_1_guard_Normal_SM1) {
        SM1_fired_strong_partial = _46_SSM_TR_Normal_Detection_1_Normal_SM1;
      }
      else {
        SM1_fired_strong_partial = _43_SSM_TR_no_trans_SM1;
      }
  ...
  switch (outC->SM1_state_act) {
    case _41_SSM_st_Failure_SM1 :
      ...
      _6_SM1_state_nxt_partial = _41_SSM_st_Failure_SM1;
    ...
    case _40_SSM_st_Detection_SM1 :
      ...
      _2_SM1_state_nxt_partial = _40_SSM_st_Detection_SM1;
    ...
    case _42_SSM_st_Normal_SM1 :
      ...
      SM1_state_nxt_partial = _42_SSM_st_Normal_SM1;
...
void C4_close_EV_sensors_door__init(outC_C4_close_EV_sensors_door_ *outC)
{
  outC->_L20 = kcg_true;
  outC->_L14 = kcg_true;
  outC->_L9 = kcg_true;
  ...
  outC->_L5 = kcg_true;
  outC->_L4 = kcg_true;
  outC->close_EV_changed = kcg_true;
  outC->any_door_opened_true = kcg_true;
  outC->SM1_fired = _43_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _43_SSM_TR_no_trans_SM1;
  outC->SM1_state_act = _42_SSM_st_Normal_SM1;
  outC->SM1_state_sel = _42_SSM_st_Normal_SM1;
  outC->_L1_Failure_SM1 = kcg_true;
  ...
  outC->SM1_state_nxt = _42_SSM_st_Normal_SM1;
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void C4_close_EV_sensors_door__reset(outC_C4_close_EV_sensors_door_ *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
