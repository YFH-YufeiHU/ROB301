...
#include "Door_open_true.h"

/* Door_open_true/ */
void Door_open_true(inC_Door_open_true *inC, outC_Door_open_true *outC)
{
  /* anomaly/ */
  ...
  /* last_close_EV/ */
  if (outC->init1) {
    last_last_close_EV = inC->close_EV;
  }
  else {
    last_last_close_EV = outC->mem_last_close_EV;
  }
  outC->mem_last_close_EV = inC->last_close_EV;
  ...
  outC->_L6 = inC->door_open_right;
  outC->_L5 = inC->door_open_lelf;
  outC->_L4 = inC->door_open_front;
  outC->_L7 = outC->_L4 & outC->_L5 & outC->_L6;
  outC->all_doors_open_true = outC->_L7;
  switch (outC->SM1_state_sel) {
    case SSM_st_Detection_SM1 :
      tr_1_guard_Detection_SM1 = outC->all_doors_open_true == kcg_false;
  ...
  outC->_L8 = inC->close_EV;
  outC->_L9 = outC->_L8 != outC->_L13;
  ...
  switch (outC->SM1_state_sel) {
    ...
    case SSM_st_Normal_SM1 :
      tr_1_guard_Normal_SM1 = inC->close_EV & outC->close_EV_changed;
...
void Door_open_true_init(outC_Door_open_true *outC)
{
  outC->_L13 = kcg_true;
  outC->_L9 = kcg_true;
  outC->_L8 = kcg_true;
  ...
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->mem_last_close_EV = kcg_true;
...
void Door_open_true_reset(outC_Door_open_true *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
