...
/* C2_open_EV_sensors_door_opened/SM1: */
typedef enum kcg_tag_SSM_TR_SM1 {
  SSM_TR_no_trans_SM1,
  SSM_TR_Normal_Detection_1_Normal_SM1,
  SSM_TR_Detection_Normal_1_Detection_SM1,
  SSM_TR_Detection_Failure_2_Detection_SM1
} SSM_TR_SM1;
/* C2_open_EV_sensors_door_opened/SM1: */
typedef enum kcg_tag_SSM_ST_SM1 {
  SSM_st_Normal_SM1,
  SSM_st_Detection_SM1,
  SSM_st_Failure_SM1
} SSM_ST_SM1;
#endif /* _KCG_TYPES_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
