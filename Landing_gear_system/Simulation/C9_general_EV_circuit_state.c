...
#include "C9_general_EV_circuit_state.h"

/* C9_general_EV_circuit_state/ */
void C9_general_EV_circuit_state(
  ...
  outC_C9_general_EV_circuit_state *outC)
{
  ...
  switch (outC->SM1_state_sel) {
    ...
    case SSM_st_Detection_SM1 :
      ...
      tr_1_guard_Detection_SM1 = inC->circuit_pressurized == kcg_true;
  ...
  switch (outC->SM1_state_sel) {
    ...
    case SSM_st_Normal_SM1 :
      tr_1_guard_Normal_SM1 = inC->general_EV & outC->general_EV_changed;
...
void C9_general_EV_circuit_state_init(outC_C9_general_EV_circuit_state *outC)
{
  outC->_L14 = kcg_true;
  outC->_L9 = kcg_true;
...
void C9_general_EV_circuit_state_reset(outC_C9_general_EV_circuit_state *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
