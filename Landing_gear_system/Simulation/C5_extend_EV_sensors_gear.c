...
void C5_extend_EV_sensors_gear(
  ...
  outC_C5_extend_EV_sensors_gear *outC)
{
  ...
  /* SM1: */
  _10_SSM_ST_SM1 _9_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _10_SM1_reset_act_partial;
  /* SM1: */
  _11_SSM_TR_SM1 _11_SM1_fired_strong_partial;
  /* SM1:Detection:<2> */
  kcg_bool tr_2_guard_Detection_SM1;
  /* SM1:Detection:<1> */
  kcg_bool tr_1_guard_Detection_SM1;
  /* SM1: */
  _10_SSM_ST_SM1 _12_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _13_SM1_reset_act_partial;
  /* SM1: */
  _11_SSM_TR_SM1 _14_SM1_fired_strong_partial;
  /* SM1: */
  ...
  outC->_L18 = outC->_L4 | outC->_L5 | outC->_L6;
  /* _L14= */
  if (outC->init1) {
    outC->_L14 = kcg_false;
  }
  ...
  switch (outC->SM1_state_sel) {
    case _48_SSM_st_Failure_SM1 :
      _12_SM1_state_act_partial = _48_SSM_st_Failure_SM1;
      break;
    case _47_SSM_st_Detection_SM1 :
  ...
  outC->any_gear_retracted_true = outC->_L18;
  switch (outC->SM1_state_sel) {
    case _47_SSM_st_Detection_SM1 :
      tr_1_guard_Detection_SM1 = outC->any_gear_retracted_true == kcg_false;
      if (tr_1_guard_Detection_SM1) {
        _9_SM1_state_act_partial = _49_SSM_st_Normal_SM1;
      }
      else if (tr_2_guard_Detection_SM1) {
        _9_SM1_state_act_partial = _48_SSM_st_Failure_SM1;
      }
      else {
        _9_SM1_state_act_partial = _47_SSM_st_Detection_SM1;
      }
      break;
    default :
      /* this branch is empty */
  ...
  outC->extend_EV_changed = outC->_L9;
  /* SM1: */
  switch (outC->SM1_state_sel) {
    case _48_SSM_st_Failure_SM1 :
      outC->SM1_state_act = _12_SM1_state_act_partial;
      _14_SM1_fired_strong_partial = _50_SSM_TR_no_trans_SM1;
      outC->SM1_fired_strong = _14_SM1_fired_strong_partial;
      break;
    case _47_SSM_st_Detection_SM1 :
      outC->SM1_state_act = _9_SM1_state_act_partial;
      if (tr_1_guard_Detection_SM1) {
        _11_SM1_fired_strong_partial = _51_SSM_TR_Detection_Normal_1_Detection_SM1;
      }
      else if (tr_2_guard_Detection_SM1) {
        _11_SM1_fired_strong_partial = _52_SSM_TR_Detection_Failure_2_Detection_SM1;
      }
      else {
        _11_SM1_fired_strong_partial = _50_SSM_TR_no_trans_SM1;
      }
      outC->SM1_fired_strong = _11_SM1_fired_strong_partial;
      break;
    case _49_SSM_st_Normal_SM1 :
      tr_1_guard_Normal_SM1 = extend_EV & outC->extend_EV_changed;
      if (tr_1_guard_Normal_SM1) {
        SM1_state_act_partial = _47_SSM_st_Detection_SM1;
      }
      else {
        SM1_state_act_partial = _49_SSM_st_Normal_SM1;
      }
      outC->SM1_state_act = SM1_state_act_partial;
      if (tr_1_guard_Normal_SM1) {
        SM1_fired_strong_partial = _53_SSM_TR_Normal_Detection_1_Normal_SM1;
      }
      else {
        SM1_fired_strong_partial = _50_SSM_TR_no_trans_SM1;
      }
  ...
  switch (outC->SM1_state_act) {
    case _48_SSM_st_Failure_SM1 :
      ...
      _6_SM1_state_nxt_partial = _48_SSM_st_Failure_SM1;
    ...
    case _47_SSM_st_Detection_SM1 :
      ...
      _2_SM1_state_nxt_partial = _47_SSM_st_Detection_SM1;
    ...
    case _49_SSM_st_Normal_SM1 :
      ...
      SM1_state_nxt_partial = _49_SSM_st_Normal_SM1;
...
void C5_extend_EV_sensors_gear_init(outC_C5_extend_EV_sensors_gear *outC)
{
  outC->_L18 = kcg_true;
  outC->_L14 = kcg_true;
  outC->_L9 = kcg_true;
  ...
  outC->_L5 = kcg_true;
  outC->_L4 = kcg_true;
  outC->extend_EV_changed = kcg_true;
  outC->any_gear_retracted_true = kcg_true;
  outC->SM1_fired = _50_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _50_SSM_TR_no_trans_SM1;
  outC->SM1_state_act = _49_SSM_st_Normal_SM1;
  outC->SM1_state_sel = _49_SSM_st_Normal_SM1;
  outC->_L1_Failure_SM1 = kcg_true;
  ...
  outC->SM1_state_nxt = _49_SSM_st_Normal_SM1;
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void C5_extend_EV_sensors_gear_reset(outC_C5_extend_EV_sensors_gear *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
