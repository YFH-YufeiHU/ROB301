...
void C3_close_EV_sensors_door_(
  /* door_closed_front/ */
  ...
  outC_C3_close_EV_sensors_door_ *outC)
{
  ...
  /* SM1: */
  _14_SSM_ST_SM1 _2_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _3_SM1_reset_nxt_partial;
  /* SM1: */
  _15_SSM_TR_SM1 _4_SM1_fired_partial;
  /* anomaly/ */
  kcg_bool _5_anomaly_partial;
  /* SM1: */
  _14_SSM_ST_SM1 _6_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _7_SM1_reset_nxt_partial;
  /* SM1: */
  _15_SSM_TR_SM1 _8_SM1_fired_partial;
  /* SM1: */
  ...
  /* SM1: */
  _14_SSM_ST_SM1 _9_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _10_SM1_reset_act_partial;
  /* SM1: */
  _15_SSM_TR_SM1 _11_SM1_fired_strong_partial;
  /* SM1:Detection:<2> */
  kcg_bool tr_2_guard_Detection_SM1;
  /* SM1:Detection:<1> */
  kcg_bool tr_1_guard_Detection_SM1;
  /* SM1: */
  _14_SSM_ST_SM1 _12_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _13_SM1_reset_act_partial;
  /* SM1: */
  _15_SSM_TR_SM1 _14_SM1_fired_strong_partial;
  /* SM1: */
  ...
  outC->_L6 = door_closed_right;
  outC->_L5 = door_closed_left;
  outC->_L4 = door_closed_front;
  ...
  switch (outC->SM1_state_sel) {
    case _34_SSM_st_Failure_SM1 :
      _12_SM1_state_act_partial = _34_SSM_st_Failure_SM1;
      break;
    case _33_SSM_st_Detection_SM1 :
  ...
  outC->all_doors_closed_true = outC->_L19;
  switch (outC->SM1_state_sel) {
    case _33_SSM_st_Detection_SM1 :
      tr_1_guard_Detection_SM1 = outC->all_doors_closed_true == kcg_true;
      if (tr_1_guard_Detection_SM1) {
        _9_SM1_state_act_partial = _35_SSM_st_Normal_SM1;
      }
      else if (tr_2_guard_Detection_SM1) {
        _9_SM1_state_act_partial = _34_SSM_st_Failure_SM1;
      }
      else {
        _9_SM1_state_act_partial = _33_SSM_st_Detection_SM1;
      }
      break;
    default :
      /* this branch is empty */
  ...
  switch (outC->SM1_state_sel) {
    case _34_SSM_st_Failure_SM1 :
      ...
      _14_SM1_fired_strong_partial = _36_SSM_TR_no_trans_SM1;
      outC->SM1_fired_strong = _14_SM1_fired_strong_partial;
      break;
    case _33_SSM_st_Detection_SM1 :
      outC->SM1_state_act = _9_SM1_state_act_partial;
      if (tr_1_guard_Detection_SM1) {
        _11_SM1_fired_strong_partial = _37_SSM_TR_Detection_Normal_1_Detection_SM1;
      }
      else if (tr_2_guard_Detection_SM1) {
        _11_SM1_fired_strong_partial = _38_SSM_TR_Detection_Failure_2_Detection_SM1;
      }
      else {
        _11_SM1_fired_strong_partial = _36_SSM_TR_no_trans_SM1;
      }
      outC->SM1_fired_strong = _11_SM1_fired_strong_partial;
      break;
    case _35_SSM_st_Normal_SM1 :
      tr_1_guard_Normal_SM1 = close_EV & outC->close_EV_changed;
      if (tr_1_guard_Normal_SM1) {
        SM1_state_act_partial = _33_SSM_st_Detection_SM1;
      }
      else {
        SM1_state_act_partial = _35_SSM_st_Normal_SM1;
      }
      outC->SM1_state_act = SM1_state_act_partial;
      if (tr_1_guard_Normal_SM1) {
        SM1_fired_strong_partial = _39_SSM_TR_Normal_Detection_1_Normal_SM1;
      }
      else {
  ...
  switch (outC->SM1_state_act) {
    case _34_SSM_st_Failure_SM1 :
      ...
      _6_SM1_state_nxt_partial = _34_SSM_st_Failure_SM1;
    ...
    case _33_SSM_st_Detection_SM1 :
      ...
      _2_SM1_state_nxt_partial = _33_SSM_st_Detection_SM1;
    ...
    case _35_SSM_st_Normal_SM1 :
      ...
      SM1_state_nxt_partial = _35_SSM_st_Normal_SM1;
...
void C3_close_EV_sensors_door__init(outC_C3_close_EV_sensors_door_ *outC)
{
  outC->_L19 = kcg_true;
  outC->_L14 = kcg_true;
  outC->_L9 = kcg_true;
  ...
  outC->SM1_state_act = _35_SSM_st_Normal_SM1;
  outC->SM1_state_sel = _35_SSM_st_Normal_SM1;
  outC->_L1_Failure_SM1 = kcg_true;
  ...
  outC->SM1_state_nxt = _35_SSM_st_Normal_SM1;
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void C3_close_EV_sensors_door__reset(outC_C3_close_EV_sensors_door_ *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
