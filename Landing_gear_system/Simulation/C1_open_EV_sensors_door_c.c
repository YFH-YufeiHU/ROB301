...
void C1_open_EV_sensors_door_c(
  /* door_closed_front/ */
  ...
  outC_C1_open_EV_sensors_door_c *outC)
{
  ...
  /* SM1: */
  _18_SSM_ST_SM1 SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool SM1_reset_nxt_partial;
  /* SM1: */
  _19_SSM_TR_SM1 SM1_fired_partial;
  /* anomaly/ */
  kcg_bool _1_anomaly_partial;
  /* SM1: */
  _18_SSM_ST_SM1 _2_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _3_SM1_reset_nxt_partial;
  /* SM1: */
  _19_SSM_TR_SM1 _4_SM1_fired_partial;
  /* anomaly/ */
  kcg_bool _5_anomaly_partial;
  /* SM1: */
  _18_SSM_ST_SM1 _6_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _7_SM1_reset_nxt_partial;
  /* SM1: */
  _19_SSM_TR_SM1 _8_SM1_fired_partial;
  /* SM1: */
  _18_SSM_ST_SM1 SM1_state_act_partial;
  /* SM1: */
  kcg_bool SM1_reset_act_partial;
  /* SM1: */
  _19_SSM_TR_SM1 SM1_fired_strong_partial;
  /* SM1:Normal:<1> */
  kcg_bool tr_1_guard_Normal_SM1;
  /* SM1: */
  _18_SSM_ST_SM1 _9_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _10_SM1_reset_act_partial;
  /* SM1: */
  _19_SSM_TR_SM1 _11_SM1_fired_strong_partial;
  /* SM1:Detection:<2> */
  kcg_bool tr_2_guard_Detection_SM1;
  /* SM1:Detection:<1> */
  kcg_bool tr_1_guard_Detection_SM1;
  /* SM1: */
  _18_SSM_ST_SM1 _12_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _13_SM1_reset_act_partial;
  /* SM1: */
  _19_SSM_TR_SM1 _14_SM1_fired_strong_partial;
  /* SM1: */
  ...
  outC->any_doors_closed_true = outC->_L18;
  switch (outC->SM1_state_sel) {
    case SSM_st_Detection_SM1 :
      tr_1_guard_Detection_SM1 = outC->any_doors_closed_true == kcg_false;
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_Failure_SM1 :
      ...
      _14_SM1_fired_strong_partial = _25_SSM_TR_no_trans_SM1;
    ...
    case SSM_st_Detection_SM1 :
      ...
      if (tr_1_guard_Detection_SM1) {
        ...
        _11_SM1_fired_strong_partial = _25_SSM_TR_no_trans_SM1;
      }
      outC->SM1_fired_strong = _11_SM1_fired_strong_partial;
      break;
    case SSM_st_Normal_SM1 :
      tr_1_guard_Normal_SM1 = open_EV & outC->open_EV_changed;
      ...
      if (tr_1_guard_Normal_SM1) {
        ...
        SM1_fired_strong_partial = _25_SSM_TR_no_trans_SM1;
      }
...
void C1_open_EV_sensors_door_c_init(outC_C1_open_EV_sensors_door_c *outC)
{
  outC->_L18 = kcg_true;
  outC->_L14 = kcg_true;
  outC->_L9 = kcg_true;
  ...
  outC->any_doors_closed_true = kcg_true;
  outC->SM1_fired = _25_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _25_SSM_TR_no_trans_SM1;
...
void C1_open_EV_sensors_door_c_reset(outC_C1_open_EV_sensors_door_c *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
