...
static SimEnumValUtils SSM_ST_SM1_values[] = {
    ...
    { "Normal", SSM_st_Normal_SM1},
    { "Detection", SSM_st_Detection_SM1},
    { "Detection", SSM_st_Detection_SM1},
    { "Failure", SSM_st_Failure_SM1},
    { "Failure", SSM_st_Failure_SM1},
};
...
{
    *(SSM_ST_SM1*)pValue = SSM_st_Normal_SM1;
    return 1;
}
...
static SimEnumValUtils SSM_TR_SM1_values[] = {
    ...
    { "SSM_TR_no_trans_SM1", SSM_TR_no_trans_SM1},
    { "SSM_TR_Normal_Detection_1_Normal_SM1", SSM_TR_Normal_Detection_1_Normal_SM1},
    { "SSM_TR_Normal_Detection_1_Normal_SM1", SSM_TR_Normal_Detection_1_Normal_SM1},
    { "SSM_TR_Detection_Normal_1_Detection_SM1", SSM_TR_Detection_Normal_1_Detection_SM1},
    { "SSM_TR_Detection_Normal_1_Detection_SM1", SSM_TR_Detection_Normal_1_Detection_SM1},
    { "SSM_TR_Detection_Failure_2_Detection_SM1", SSM_TR_Detection_Failure_2_Detection_SM1},
    { "SSM_TR_Detection_Failure_2_Detection_SM1", SSM_TR_Detection_Failure_2_Detection_SM1},
};
