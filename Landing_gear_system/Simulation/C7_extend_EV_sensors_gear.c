...
** Generation date: 2022-03-29T14:31:12
*************************************************************$ */

#include "kcg_consts.h"
#include "kcg_sensors.h"
#include "C7_extend_EV_sensors_gear.h"

/* C7_extend_EV_sensors_gear_extended/ */
void C7_extend_EV_sensors_gear(
  inC_C7_extend_EV_sensors_gear *inC,
  outC_C7_extend_EV_sensors_gear *outC)
{
  /* anomaly/ */
  ...
  outC->_L6 = inC->gear_extended_right;
  outC->_L5 = inC->gear_extended_left;
  outC->_L4 = inC->gear_extended_front;
  ...
  switch (outC->SM1_state_sel) {
    ...
    case SSM_st_Normal_SM1 :
      tr_1_guard_Normal_SM1 = inC->extend_EV & outC->extend_EV_changed;
...
void C7_extend_EV_sensors_gear_init(outC_C7_extend_EV_sensors_gear *outC)
{
  outC->_L19 = kcg_true;
  outC->_L14 = kcg_true;
  outC->_L9 = kcg_true;
...
void C7_extend_EV_sensors_gear_reset(outC_C7_extend_EV_sensors_gear *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
...
/*
  Expanded instances for: C7_extend_EV_sensors_gear_extended/
  @1: (times#1)
*/

/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** C7_extend_EV_sensors_gear.c
** Generation date: 2022-03-29T14:31:12
*************************************************************$ */
